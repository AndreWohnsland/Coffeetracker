...
"}")
        ...
        self.PB_add_employee_2 = QtWidgets.QPushButton(OptionDialog)
        self.PB_add_employee_2.setMinimumSize(QtCore.QSize(0, 70))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        self.PB_add_employee_2.setFont(font)
        self.PB_add_employee_2.setObjectName("PB_add_employee_2")
        self.horizontalLayout_3.addWidget(self.PB_add_employee_2)
    ...
    def retranslateUi(self, OptionDialog):
        ...
        self.PB_add_employee_2.setText(_translate("OptionDialog", "Master"))

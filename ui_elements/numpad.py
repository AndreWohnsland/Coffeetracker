...
class Ui_PasswordWindow2(object):
    def setupUi(self, PasswordWindow2):
        ...
        PasswordWindow2.resize(300, 260)
        PasswordWindow2.setMinimumSize(QtCore.QSize(300, 260))
        PasswordWindow2.setMaximumSize(QtCore.QSize(300, 260))
...
"}")
        ...
        self.gridLayout = QtWidgets.QGridLayout(PasswordWindow2)
    ...
    def retranslateUi(self, PasswordWindow2):
        ...
        PasswordWindow2.setWindowTitle(_translate("PasswordWindow2", "Pay amount"))
